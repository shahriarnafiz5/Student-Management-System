namespace StudentManagementSystem
{
    partial class PrintScoreForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            panel1 = new Panel();
            label7 = new Label();
            dataGridView_score_print = new DataGridView();
            comboBox_id = new ComboBox();
            panel1.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)dataGridView_score_print).BeginInit();
            SuspendLayout();
            // 
            // btn_search
            // 
            ...
            // 
            // dataGridView_score_print
            // 
            dataGridView_score_print.AllowUserToAddRows = false;
            dataGridView_score_print.AllowUserToDeleteRows = false;
            dataGridView_score_print.BackgroundColor = Color.Gainsboro;
            dataGridView_score_print.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dataGridView_score_print.Location = new Point(14, 119);
            dataGridView_score_print.Name = "dataGridView_score_print";
            dataGridView_score_print.RowHeadersWidth = 51;
            dataGridView_score_print.RowTemplate.Height = 80;
            dataGridView_score_print.Size = new Size(1071, 532);
            dataGridView_score_print.TabIndex = 65;
            dataGridView_score_print.CellContentClick += dataGridView_score_print_CellContentClick;
            dataGridView_score_print.Click += dataGridView_score_print_Click;
            // 
            // comboBox_id
            // 
            ...
            Controls.Add(panel1);
            Controls.Add(dataGridView_score_print);
            Name = "PrintScoreForm";
            Text = "PrintScoreForm";
            Load += PrintScoreForm_Load;
            panel1.ResumeLayout(false);
            panel1.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)dataGridView_score_print).EndInit();
            ResumeLayout(false);
        }
        ...
        private DataGridView dataGridView_score_print;
